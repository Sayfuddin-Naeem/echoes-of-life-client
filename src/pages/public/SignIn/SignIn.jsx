...
import HeroLogo from "../../../components/shared/Logos/HeroLogo";
...
export default function SignIn() {
  ...
  return (
    <>
      <title>Sign In - Echoes of Life</title>
      <div className="min-h-screen bg-gradient flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          {/* Logo */}
          <div className="text-center mb-8">
            {" "}
          <div className="inline-block p-2 bg-blue-200 rounded-2xl mb-4 shadow-lg">
            {" "}
            <HeroLogo size={60} />{" "}
          </div>{" "}
            <h1 className="text-4xl font-bold font-inter text-base-content mb-2">
              Welcome Back 👋
            </h1>
            <p className="text-neutral font-inter">
              Continue your life lesson
            </p>
          </div>
